...
namespace PayComplete.Persistence.Migrations
{
    ...
    [Migration("20200610210642_UpdatedEmployeeModelAndTable")]
    partial class UpdatedEmployeeModelAndTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayComplete.Entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayComplete.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayComplete.Entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayComplete.Entity.PaymentRecord", b =>
                {
                    b.HasOne("PayComplete.Entity.Employee", "Employee")
                        .WithMany("PaymentRecords")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayComplete.Entity.TaxYear", "TaxYear")
                        .WithMany()
